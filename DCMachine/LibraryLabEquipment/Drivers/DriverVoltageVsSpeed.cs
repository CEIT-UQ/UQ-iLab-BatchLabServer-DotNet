...
{
    public class DriverVoltageVsSpeed : DriverEquipment
    {
        #region Constants
        private const string STR_ClassName = "DriverVoltageVsSpeed";
        ...
        private enum States
        {
            ...
            // ExecuteStarting
            StartACDrive, EnableDCDrive,

            // ExecuteRunning
            SetSpeedACDrive, CheckSpeed, MeasurementDelay, TakeMeasurements,

            // ExecuteStopping
            ResetSpeedACDrive, StopDCDrive, StopACDrive, DisableACDrive,
        ...
        public DriverVoltageVsSpeed(LabEquipmentConfiguration labEquipmentConfiguration)
            : base(labEquipmentConfiguration)
        {
            const string methodName = "DriverVoltageVsSpeed";
        ...
        public override Validation Validate(String xmlSpecification)
        {
            ...
            try
            {
                ...
                if (setupId.Equals(Consts.STRXML_SetupId_VoltageVsSpeed) == false)
                {
        ...
        protected override int GetExecutionTime(ExperimentSpecification experimentSpecification)
        {
            ...
            this.executionTimes.Run = tallyLength * (this.deviceRedLion.GetACDrive.ChangeSpeedTime + (this.measurementCount * this.measurementDelay));
        ...
        protected override bool ExecuteRunning()
        {
            ...
            try
            {
                ...
                States lastState = States.None;
                States thisState = States.SetSpeedACDrive;
                ...
                while (thisState != States.Done)
                {
                    ...
                    switch (thisState)
                    {
                        case States.SetSpeedACDrive:
                            ...
                            speedACDrive = this.experimentSpecification.SpeedMin + (tallyIndex * this.experimentSpecification.SpeedStep);
                            if (this.deviceRedLion.GetACDrive.ChangeSpeed(speedACDrive) == false)
                            {
                                throw new ApplicationException(this.deviceRedLion.GetACDrive.LastError);
                            }
        ...
        protected override bool ExecuteStopping()
        {
            ...
            try
            {
                 ...
                 */
                States lastState = States.None;
                States thisState = States.ResetSpeedACDrive;
