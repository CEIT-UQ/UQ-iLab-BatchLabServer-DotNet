...
namespace Library.LabEquipment.Devices
{
    public class DeviceRedLion : DeviceGeneric
    {
        ...
        private PowerMeterMut powerMeterMut;
        private PowerMeterVsd powerMeterVsd;
        ...
        public PowerMeterMut GetPowerMeterMut
        {
            get { return powerMeterMut; }
        }

        public PowerMeterVsd GetPowerMeterVsd
        {
            get { return powerMeterVsd; }
        }
        ...
        public override bool Initialise()
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        if (this.powerMeterMut.Initialise() == false)
                        {
                            throw new ApplicationException(this.powerMeterMut.LastError);
                        }
                        if (this.powerMeterVsd.Initialise() == false)
                        {
                            throw new ApplicationException(this.powerMeterVsd.LastError);
                        }
        ...
        public bool OpenConnection()
        {
            ...
            try
            {
                ...
                this.powerMeterMut = new PowerMeterMut(modbusIpMaster, this.slaveId);
                this.powerMeterVsd = new PowerMeterVsd(modbusIpMaster, this.slaveId);
