...
{
    public class DriverLockedRotor : DriverEquipment
    {
        #region Constants
        private const string STR_ClassName = "DriverLockedRotor";
        ...
        public DriverLockedRotor(LabEquipmentConfiguration labEquipmentConfiguration)
            : base(labEquipmentConfiguration)
        {
            const string methodName = "DriverLockedRotor";
        ...
        public override Validation Validate(String xmlSpecification)
        {
            ...
            try
            {
                ...
                if (setupId.Equals(Consts.STRXML_SetupId_LockedRotor) == false)
                {
                ...
                while (thisState != States.Done)
                {
                    ...
                    switch (thisState)
                    {
                        ...
                        case States.SetSpeed:
                            ...
                            if (this.deviceRedLion.GetACDrive.SetControlSpeed(ACDrive.SPEED_LockedRotor) == false)
                            {
                                throw new ApplicationException(this.deviceRedLion.GetACDrive.LastError);
                            }
                        ...
                        case States.StartDrive:
                            ...
                            if (this.deviceRedLion.GetACDrive.StartDriveLockedRotor() == false)
                            {
                                throw new ApplicationException(this.deviceRedLion.GetACDrive.LastError);
                            }
                        ...
                        case States.CheckSpeed:
                             ...
                             */
                            int requiredSpeed = ACDrive.SPEED_LockedRotor;
                ...
                while (thisState != States.Done)
                {
                    ...
                    switch (thisState)
                    {
                        case States.StopDrive:
                            ...
                            if (this.deviceRedLion.GetACDrive.StopDriveLockedRotor() == false)
                            {
                                if (lastError == null)
                                {
