...
{
    public class DriverNoLoad : DriverEquipment
    {
        #region Constants
        private const string STR_ClassName = "DriverNoLoad";
        ...
        public DriverNoLoad(LabEquipmentConfiguration labEquipmentConfiguration)
            : base(labEquipmentConfiguration)
        {
            const string methodName = "DriverNoLoad";
        ...
        public override Validation Validate(String xmlSpecification)
        {
            ...
            try
            {
                ...
                if (setupId.Equals(Consts.STRXML_SetupId_NoLoad) == false)
                {
                ...
                while (thisState != States.Done)
                {
                    ...
                    switch (thisState)
                    {
                        ...
                        case States.SetSpeed:
                            ...
                            if (this.deviceRedLion.GetACDrive.SetControlSpeed(ACDrive.SPEED_NoLoad) == false)
                            {
                                throw new ApplicationException(this.deviceRedLion.GetACDrive.LastError);
                            }
                        ...
                        case States.StartDrive:
                            ...
                            if (this.deviceRedLion.GetACDrive.StartDriveNoLoad() == false)
                            {
                                throw new ApplicationException(this.deviceRedLion.GetACDrive.LastError);
                            }
                        ...
                        case States.CheckSpeed:
                             ...
                             */
                            int requiredSpeed = -ACDrive.SPEED_NoLoad;
                ...
                while (thisState != States.Done)
                {
                    ...
                    switch (thisState)
                    {
                        case States.StopDrive:
                            ...
                            if (this.deviceRedLion.GetACDrive.StopDriveNoLoad() == false)
                            {
                                if (lastError == null)
                                {
