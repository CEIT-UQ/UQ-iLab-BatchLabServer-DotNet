...
{
    public class DriverFullLoad : DriverEquipment
    {
        #region Constants
        private const string STR_ClassName = "DriverFullLoad";
        ...
        public DriverFullLoad(LabEquipmentConfiguration labEquipmentConfiguration)
            : base(labEquipmentConfiguration)
        {
            const string methodName = "DriverFullLoad";
        ...
        public override Validation Validate(String xmlSpecification)
        {
            ...
            try
            {
                ...
                if (setupId.Equals(Consts.STRXML_SetupId_FullLoad) == false)
                {
                ...
                while (thisState != States.Done)
                {
                    ...
                    switch (thisState)
                    {
                        ...
                        case States.SetSpeed:
                            ...
                            if (this.deviceRedLion.GetACDrive.SetControlSpeed(ACDrive.SPEED_FullLoad) == false)
                            {
                                throw new ApplicationException(this.deviceRedLion.GetACDrive.LastError);
                            }
                        ...
                        case States.StartDrive:
                            ...
                            if (this.deviceRedLion.GetACDrive.StartDriveFullLoad() == false)
                            {
                                throw new ApplicationException(this.deviceRedLion.GetACDrive.LastError);
                            }
                        ...
                        case States.CheckSpeed:
                            ...
                            /*
                             * Check speed is within error of required speed (speed is other direction)
                             */
                            int requiredSpeed = -ACDrive.SPEED_FullLoad;
                ...
                while (thisState != States.Done)
                {
                    ...
                    switch (thisState)
                    {
                        ...
                        case States.TakeMeasurements:
                             ...
                             */
                            measurementsToAverage.voltageMut += measurement.voltageMut;
                            measurementsToAverage.currentMut += measurement.currentMut;
                            measurementsToAverage.powerFactorMut += measurement.powerFactorMut;
                            ...
                            if (--measurementCount == 0)
                            {
                                 ...
                                 */
                                measurementsToAverage.voltageMut /= this.measurementCount;
                                measurementsToAverage.currentMut /= this.measurementCount;
                                measurementsToAverage.powerFactorMut /= this.measurementCount;
                                measurementsToAverage.speed /= this.measurementCount;

                                /*
                                 * Save the measurements to the results
                                 */
                                this.experimentResults.MeasurementData.voltageMut[0] = measurementsToAverage.voltageMut;
                                this.experimentResults.MeasurementData.currentMut[0] = measurementsToAverage.currentMut;
                                this.experimentResults.MeasurementData.powerFactorMut[0] = measurementsToAverage.powerFactorMut;
                ...
                while (thisState != States.Done)
                {
                    ...
                    switch (thisState)
                    {
                        case States.StopDrive:
                            ...
                            if (this.deviceRedLion.GetACDrive.StopDriveFullLoad() == false)
                            {
                                if (lastError == null)
                                {
