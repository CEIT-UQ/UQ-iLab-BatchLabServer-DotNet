        ...
        protected override DriverGeneric GetDriver(string setupId)
        {
            ...
            switch (setupId)
            {
                case Consts.STRXML_SetupId_NoLoad:
                    driverGeneric = new DriverNoLoad(this.labEquipmentConfiguration);
                    break;

                case Consts.STRXML_SetupId_FullLoad:
                    driverGeneric = new DriverFullLoad(this.labEquipmentConfiguration);
                    break;

                case Consts.STRXML_SetupId_LockedRotor:
                    driverGeneric = new DriverLockedRotor(this.labEquipmentConfiguration);
                    break;

                case Consts.STRXML_SetupId_SynchronousSpeed:
                    driverGeneric = new DriverSynchronousSpeed(this.labEquipmentConfiguration);
                    break;
